...
const BLOCKS = [
  ...
  { id: 'button', category: 'Content',
    ...
    content: `<a href="#" class="fx-btn" style="display:inline-block;padding:12px 28px;background:#4f46e5;color:#fff;border-radius:30px;text-decoration:none;font-weight:600;font-size:1rem;">Click Me</a>` },
  ...
  { id: 'hero', category: 'Sections',
    ...
    content: `<section style="padding:80px 40px;text-align:center;background:linear-gradient(135deg,#4f46e5,#7c3aed);color:#fff;"><h1 style="font-size:3rem;font-weight:800;margin:0 0 1rem;">Welcome to Our Site</h1><p style="font-size:1.2rem;margin:0 auto 2rem;max-width:600px;opacity:0.9;">A short description of your product.</p><a href="#" class="fx-btn" style="display:inline-block;padding:14px 32px;background:#fff;color:#4f46e5;border-radius:30px;text-decoration:none;font-weight:700;">Get Started</a></section>` },
