...
const s = {
  ...
  cta: { marginTop: '0.5rem', padding: '0.8rem 1.8rem', background: '#4f46e5', color: '#fff', border: 'none', borderRadius: '10px', fontSize: '0.95rem', fontWeight: '600', cursor: 'pointer', fontFamily: "'Poppins', sans-serif", boxShadow: '0 8px 24px rgba(79,70,229,0.4)', transition: 'transform 0.15s, background 0.15s' },
