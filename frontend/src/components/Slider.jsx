...
/*
 * Reusable hero slider. Self-contained: fetches its own slides and renders
 * nothing when there are none, so it's safe to drop into any page.
 *
 * Props:
 *   autoPlay  — advance automatically (default true)
 *   interval  — ms between auto-advances (default 6000)
 *   height    — CSS height of the slider (default 'clamp(360px, 60vh, 600px)')
 */
const Slider = ({ autoPlay = true, interval = 6000, height = 'clamp(360px, 60vh, 600px)' }) => {
...
const s = {
  wrap: {
    ...
    background: '#0f172a', fontFamily: "'Poppins', sans-serif",
  },
  slide: {
  ...
  content: {
    ...
    maxWidth: '760px', padding: '0 1.5rem',
    display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem',
  },
  heading: {
    fontSize: 'clamp(1.8rem, 4vw, 3.2rem)', fontWeight: '800', lineHeight: 1.15,
    margin: 0, textShadow: '0 2px 16px rgba(0,0,0,0.4)',
  },
  subtext: {
    fontSize: 'clamp(0.95rem, 1.6vw, 1.2rem)', fontWeight: '400', lineHeight: 1.6,
    margin: 0, opacity: 0.95, textShadow: '0 1px 8px rgba(0,0,0,0.4)',
  },
  cta: {
    marginTop: '0.5rem', padding: '0.8rem 1.8rem',
    background: '#4f46e5', color: '#fff', border: 'none', borderRadius: '10px',
    fontSize: '0.95rem', fontWeight: '600', cursor: 'pointer',
    fontFamily: "'Poppins', sans-serif", boxShadow: '0 8px 24px rgba(79,70,229,0.4)',
